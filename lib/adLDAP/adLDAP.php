...
class adLDAP {
    ...
    */
    ...
    /**
     * The Active Directory key used to find/identify users
     * 
     * @var string
     */
    ...
    /**
     * Search filter used for finding people
     * @var string
     */
    protected $searchFilter = "objectCategory=person";
    ...
    */
    function __construct($options = array()) {
        ...
        if (count($options) > 0) {
            ...
            if (array_key_exists("user_id_key",$options)){ $this->userIdKey = $options["user_id_key"]; }
            if (array_key_exists("search_filter",$options)){ $this->searchFilter = $options["search_filter"]; }
