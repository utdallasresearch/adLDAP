...
class adLDAPUsers {
    ...
    */
    public function info($username, $fields = null, $isGUID = false)
    {
        ...
        $searchFilter = $this->adldap->getSearchFilter();
        if ($isGUID === true) {
            ...
            $filter = "objectguid=" . $username;
             ...
             $filter = $userIdKey . "=" . $username;
        }
        $filter = "(&({$searchFilter})({$filter}))";
        if ($fields === null) {
            $fields = array("{$userIdKey}","mail","memberof","department","displayname","telephonenumber","primarygroupid","objectsid"); 
        }
